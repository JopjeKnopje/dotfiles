...
-- copy into system clipboard otherwise just use nvims 'clipboard'
keymap("n", "<leader>y", "\"+y", opts)
keymap("n", "<leader>Y", "\"+y", opts)
keymap("v", "<leader>Y", "\"+y", opts)

-- deletion into void register instead of into clipboard
...
-- straight up replace all on currentword
